...
#' Print validation information
#' Work only on class validation.partial
#'
#' @param partial_validation Object generated by [validateData()] for
#' which columns are not valide.
#'
#' @return NULL Print validation information on CLI
print.partial.validation <- function(partial_validation){

        # Columns output
        messageColumns(partial_validation$details$columns)
...
#' Print if column names are found
#' Called by [print.validation()]
#'
...
#' Generic  function to print count information
#' Called by [print.validation()]
#'
